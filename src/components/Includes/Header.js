...
import {
  logoutAction,
  destroyUserAuthislogged,
  disableActivationIslogged,
  getAllCurrencyPost,
  chosePreferredCurrency,
} from "../../redux";
...
function Header() {
  ...
  if (typeof default_currency === "object") {
    defaultCurrency =
      "unique_id" in default_currency
        ? default_currency.unique_id
        : "4hqoeefnnp8pci4bs9js";
  }
  ...
  //login data
  let { isLogged, user_data, logout_loading, logout_error, logout_success } =
    loginData;
      ...
      <header className="top-bar white-overlay-top">
                  ...
                  <ul className="list-inline d-lg-flex justify-content-end">
                    <li className="me-10 ps-10 lng-drop">
                      <select
                        ...
                        className="header-lang-bx selectpicker "
                      >
                        {currencyArray.map((currency, index) => (
                          <option key={index} value={currency.unique_id}>
                            {" "}
                    ...
                    <li className="me-10 ps-10">
                      {isLogged === false ? (
                        ...
                        <span
                          ...
                          onClick={() => logUserOut(token)}
                        >
                          {logout_loading === true ? (
                            "Loading....."
                          ) : (
                            <>
                              <i className="fa fa-sign-out d-md-inline-block d-none" />{" "}
                              Logout{" "}
                            </>
                          )}
                        </span>
                          ...
                          {isLogged && (
                            <>
                              ...
                              <Link
                                ...
                                to="#"
                              >
                                <i className="fa fa-sign-out text-white" /> Log
                                Out
                              </Link>
                            </>
                          )}
        ...
        <nav hidden className="nav-white nav-transparent dark-overlay">
          ...
          <ul className="menu">
            ...
            <li>
              <Link to="/roles" className="text-capitalize">
                Roles
              </Link>
            </li>
